...
class BasicInfo(models.Model):
    ...
    purpose = models.IntegerField(verbose_name='用途', choices=purpose_choices)

    variety_choices = ((0, '湖羊'), (1, '小尾'), (2, '黑山'), (3, '小尾3'), (4, '小尾4'), (5, '小尾5'), (6, '小尾6'))
    variety = models.IntegerField(verbose_name='品种', choices=variety_choices, blank=True)
    ...
    manu_info_name=models.CharField(verbose_name='产地名',max_length=50,blank=True)
    state_choices = ((0, '死亡'), (1, '正常'), (2, '销售'))
    state = models.IntegerField(verbose_name='状态', choices=state_choices)
    ...
    f_date = models.DateField(verbose_name="创建时间", default=timezone.now, blank=True)
...
class manuInfo(models.Model):
    ...
    type = models.ImageField(verbose_name='养殖场类型', choices=type_choice)
...
class BreederconditionInfo(models.Model):
    ...
    testis_shape = models.BooleanField(verbose_name='睾丸形状', choices=testis_shape_choice, blank=True)
    ...
    f_date = models.DateField(verbose_name='创建时间', default=timezone.now)
    f_staff = models.IntegerField(verbose_name='创建人员', blank=True,null=True)  ###同上
...
class cutInfo(models.Model):
    ...
    cut_time = models.IntegerField(verbose_name='剪毛时间', choices=cut_time_choice)

    rank_choice = ((0, '细毛'), (1, '粗毛'), (2, '绒毛'),(3,'细毛-同质'),(4,'粗毛同质'))  # ？？？细毛同质，每种下分同异质？
    rank = models.IntegerField(verbose_name='羊毛类型', blank=True,choices=rank_choice)

    color_choice = ((0, '白'), (1, '黑'), (2, '咖'), (3, '混合色'))
    color = models.IntegerField(verbose_name='毛色', blank=True, default=0,choices=color_choice)
