...
(function (t, n) {
    ...
    function l(t, n) {
        function e(e) {
            var u = null == i ? n.ticks ? n.ticks.apply(n, r) : n.domain() : i,
                a = null == o ? n.tickFormat ? n.tickFormat.apply(n, r) : Us : o, g = Math.max(l, 0) + p, y = n.range(),
                m = +y[0] + .5, x = +y[y.length - 1] + .5, b = (n.bandwidth ? s : c)(n.copy()),
                w = e.selection ? e.selection() : e, M = w.selectAll(".domain").data([null]),
                T = w.selectAll(".tick").data(u, n).order(), N = T.exit(),
        ...
        var r = [], i = null, o = null, l = 6, h = 6, p = 3, d = t === Ds || t === Is ? -1 : 1,
            v = t === Is || t === Os ? "x" : "y", _ = t === Ds || t === Fs ? u : a;
    ...
    function _t(t, n) {
        var e = t.document.documentElement, r = ff(t).on("dragstart.drag", null);
    ...
    function qt(t) {
        ...
        var e = Yt(t.r), r = Yt(t.g), i = Yt(t.b), o = Ot((.4124564 * e + .3575761 * r + .1804375 * i) / Cf),
    ...
    function Xt(t) {
        ...
        t instanceof At || (t = St(t));
        var n = t.r / 255, e = t.g / 255, r = t.b / 255, i = (Hf * r + Bf * n - jf * e) / (Hf + Bf - jf), o = r - i,
            u = (Yf * (e - i) - Ff * o) / If, a = Math.sqrt(u * u + o * o) / (Yf * i * (1 - i)),
    ...
    function rn(t, n, e, r) {
        ...
        function o(t, r, i, o, u, a) {
            if (t !== i || r !== o) {
                ...
                a.push({i: c - 4, x: ol(t, i)}, {i: c - 2, x: ol(r, o)})
        ...
        function c(t, n, e, r, o, u) {
            if (t !== e || n !== r) {
                ...
                u.push({i: a - 4, x: ol(t, e)}, {i: a - 2, x: ol(n, r)})
    ...
    function oe(t, n) {
        for (var e; !(e = t.__transition) || !(e = e[n]);) if (!(t = t.parentNode)) return yh.time = ln(), yh;
        return e
    }
    ...
    function he(n) {
        ...
        function r() {
            var t = ff(this), n = fe(this).selection;
        ...
        function u() {
            ...
            function o() {
                ...
                d < s && (N *= -1, t = a, a = p, p = t, t = s, s = d, d = t, M in zh && F.attr("cursor", Ch[M = zh[M]])), _ < h && (k *= -1, t = l, l = v, v = t, t = h, h = _, _ = t, M in Ph && F.attr("cursor", Ch[M = Ph[M]])), S.selection && (A = S.selection), x && (s = A[0][0], d = A[1][0]), b && (h = A[0][1], _ = A[1][1]), A[0][0] === s && A[0][1] === h && A[1][0] === d && A[1][1] === _ || (S.selection = [[s, h], [d, _]], r.call(w), D.brush())
            }
            ...
            if (f.apply(this, arguments)) {
                var a, s, l, h, p, d, v, _, g, y, m, x, b, w = this, M = t.event.target.__data__.type,
                    T = "selection" === (t.event.metaKey ? M = "overlay" : M) ? Mh : t.event.altKey ? kh : Nh,
                    N = n === Eh ? null : Rh[M], k = n === Sh ? null : Lh[M], S = fe(w), E = S.extent, A = S.selection,
                    C = E[0][0], z = E[0][1], P = E[1][0], R = E[1][1], L = N && k && t.event.shiftKey, q = nf(w),
                    U = q, D = i(w, arguments).beforestart();
                "overlay" === M ? S.selection = A = [[a = n === Eh ? C : q[0], l = n === Sh ? z : q[1]], [p = n === Eh ? P : a, v = n === Sh ? R : l]] : (a = A[0][0], l = A[0][1], p = A[1][0], v = A[1][1]), s = a, h = l, d = p, _ = v;
                var O = ff(w).attr("pointer-events", "none"), F = O.selectAll(".overlay").attr("cursor", Ch[M]);
        ...
        return e.move = function (t, e) {
            t.selection ? t.on("start.brush", function () {
                ...
                var o = this, u = o.__brush, a = i(o, arguments), c = u.selection,
                    s = n.input("function" == typeof e ? e.apply(this, arguments) : e, u.extent), f = fl(c, s);
                return c && s ? t : t(1)
            }) : t.each(function () {
    ...
    function or(t, n) {
        n = (n *= vd) / 2 + hd;
        var e = (t *= vd) - Rp, r = e >= 0 ? 1 : -1, i = r * e, o = md(n), u = Td(n), a = qp * u,
            c = Lp * o + a * md(i), s = a * r * Td(i);
    ...
    function dr(t, n) {
        var e = ar([t * vd, n * vd]);
        if (jp) {
            var r = sr(jp, e), i = sr([r[1], -r[0], 0], r);
            hr(i), i = ur(i);
    ...
    function Sr(t, n) {
        t *= vd;
        var e = md(n *= vd), r = e * md(t), i = e * Td(t), o = Td(n),
    ...
    function Pr(t, n) {
        t *= vd;
        var e = md(n *= vd), r = e * md(t), i = e * Td(t), o = Td(n), u = ud * o - ad * i, a = ad * r - od * o,
            c = od * i - ud * r, s = kd(u * u + a * a + c * c), f = Ge(s), l = s && -f / s;
    ...
    function Dr(t, n) {
        function e(t, n) {
            var e = md(n), a = md(t) * e, c = Td(t) * e, s = Td(n), f = s * r + a * i;
            return [yd(c * o - f * u, a * r - s * i), Ge(f * o + c * u)]
        }

        var r = md(t), i = Td(t), o = md(n), u = Td(n);
        return e.invert = function (t, n) {
            var e = md(n), a = md(t) * e, c = Td(t) * e, s = Td(n), f = s * o - c * u;
    ...
    function Wr(t, n) {
        t *= vd;
        var e = Td(n *= vd), r = md(n), i = _d(t - Fd), o = md(i), u = r * Td(i), a = Yd * e - Id * r * o,
            c = Id * e + Yd * r * o;
    ...
    function li(t, n) {
        var e = t - Wd, r = n - Zd, i = kd(e * e + r * r);
    ...
    function Ti(t, n, e) {
        ...
        var u = Tv.result(), a = Math.min(r / (u[1][0] - u[0][0]), i / (u[1][1] - u[0][1])),
    ...
    function Si(t, n) {
        function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
            ...
            if (m > 4 * n && v--) {
                var x = u + h, b = a + p, w = c + d, M = kd(x * x + b * b + w * w), T = Ge(w /= M),
                    N = _d(_d(w) - 1) < sd || _d(o - l) < sd ? (o + l) / 2 : yd(b, x), k = t(N, T), S = k[0], E = k[1],
                    A = S - r, C = E - i, z = y * A - g * C;
    ...
    function Ri(t, n) {
        ...
        var r = Td(t), i = (r + Td(n)) / 2;
        if (_d(i) < sd) return Pi(t);
        var o = 1 + r * (2 * i - r), u = kd(o) / i;
        return e.invert = function (t, n) {
            var e = u - n;
    ...
    function Ui(t) {
        return function (n, e) {
            var r = kd(n * n + e * e), i = t(r), o = Td(i), u = md(i);
    ...
    function Oi(t) {
        function n() {
            var n = fd * a(), u = o(Gd(o.rotate()).invert([0, 0]));
    ...
    function Ii(t, n) {
        ...
        var r = md(t), i = t === n ? Td(t) : wd(r / md(n)) / wd(Fi(n) / Fi(t)), o = r * Md(Fi(t), i) / i;
        return i ? (e.invert = function (t, n) {
            var e = o - n, r = Nd(i) * kd(t * t + e * e);
    ...
    function Bi(t, n) {
        ...
        var r = md(t), i = t === n ? Td(t) : (r - md(n)) / (n - t), o = r / i + t;
    ...
    function io(t, n) {
        ...
        for (null == n && (n = oo); e = s.pop();) if (c && (e.value = +e.data.value), (i = n(e.data)) && (u = i.length)) for (e.children = new Array(u), o = u - 1; o >= 0; --o) s.push(r = e.children[o] = new co(i[o])), r.parent = e, r.depth = e.depth + 1;
    ...
    function yo(t, n, e) {
        var r = t.x, i = t.y, o = t.r, u = n.x, a = n.y, c = n.r, s = e.x, f = e.y, l = e.r, h = r - u, p = r - s,
            d = i - a, v = i - f, _ = c - o, g = l - o, y = r * r + i * i - o * o, m = y - u * u - a * a + c * c,
            x = y - s * s - f * f + l * l, b = p * d - h * v, w = (d * x - v * m) / (2 * b) - r,
            M = (v * _ - d * g) / b, T = (p * m - h * x) / (2 * b) - i, N = (h * g - p * _) / b, k = M * M + N * N - 1,
    ...
    function Io(t) {
        for (var n, e, r, i, o, u = new Fo(t, 0), a = [u]; n = a.pop();) if (r = n._.children) for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) a.push(e = n.children[i] = new Fo(r[i], i)), e.parent = n;
    ...
    function Xo(t) {
        if (!t._start) try {
            ...
            if (t._tasks[t._ended + t._active - 1]) Wo(t, n); else if (!t._data) throw n
        }
    }
    ...
    function mu() {
        ...
        var e = su(pu, du).domain([1, 10]), r = e.domain, i = 10, o = gu(10), u = _u(10);
    ...
    function zu(t) {
        ...
        var i = t.dateTime, o = t.date, u = t.time, a = t.periods, c = t.days, s = t.shortDays, f = t.months,
            l = t.shortMonths, h = Lu(a), p = qu(a), d = Lu(c), v = qu(c), _ = Lu(s), g = qu(s), y = Lu(f), m = qu(f),
            x = Lu(l), b = qu(l), w = {
                a: function (t) {
                    return s[t.getDay()]
                }, A: function (t) {
                    ...
                    return f[t.getMonth()]
                }, c: null, d: Gu, e: Gu, H: Ju, I: Qu, j: Ku, L: ta, m: na, M: ea, p: function (t) {
                    return a[+(t.getHours() >= 12)]
                }, S: ra, U: ia, w: oa, W: ua, x: null, X: null, y: aa, Y: ca, Z: sa, "%": Ta
            }, M = {
                a: function (t) {
                ...
                }, c: null, d: fa, e: fa, H: la, I: ha, j: pa, L: da, m: va, M: _a, p: function (t) {
                    return a[+(t.getUTCHours() >= 12)]
                }, S: ga, U: ya, w: ma, W: xa, x: null, X: null, y: ba, Y: wa, Z: Ma, "%": Ta
            }, T = {
                a: function (t, n, e) {
                    ...
                    return r(t, i, n, e)
                }, d: ju, e: ju, H: Xu, I: Xu, j: Hu, L: Wu, m: Bu, M: $u, p: function (t, n, e) {
                    var r = h.exec(n.slice(e));
                    return r ? (t.p = p[r[0].toLowerCase()], e + r[0].length) : -1
                }, S: Vu, U: Du, w: Uu, W: Ou, x: function (t, n, e) {
                    return r(t, o, n, e)
                }, X: function (t, n, e) {
                    return r(t, u, n, e)
                }, y: Iu, Y: Fu, Z: Yu, "%": Zu
    ...
    function Ea(t, n, e, r, o, u, a, c, s) {
        ...
        function l(n, e, r, o) {
            if (null == n && (n = 10), "number" == typeof n) {
                var u = Math.abs(r - e) / n, a = hs(function (t) {
                    return t[2]
                }).right(M, u);
        ...
        var h = su(ru, ol), p = h.invert, d = h.domain, v = s(".%L"), _ = s(":%S"), g = s("%I:%M"), y = s("%I %p"),
    ...
    function Fa(t, n, e, r, i, o, u) {
        var a = t - e, c = n - r, s = (u ? o : -o) / yy(a * a + c * c), f = s * c, l = -s * a, h = t + f, p = n + l,
            d = e + f, v = r + l, _ = (h + d) / 2, g = (p + v) / 2, y = d - h, m = v - p, x = y * y + m * m, b = i - o,
            w = h * v - d * p, M = (m < 0 ? -1 : 1) * yy(vy(0, b * b * x - w * w)), T = (w * m - y * M) / x,
            N = (-w * y - m * M) / x, k = (w * m + y * M) / x, S = (-w * y + m * M) / x, E = T - _, A = N - g,
            C = k - _, z = S - g;
    ...
    function Ja(t, n, e, r, i) {
        var o = zy(n, e), u = zy(n, e = (e + i) / 2), a = zy(r, e), c = zy(r, i);
    ...
    function Dc(t) {
        return lm[t.index] = {site: t, halfedges: []}
    }
    ...
    function Yc() {
        for (var t, n, e, r, i = 0, o = lm.length; i < o; ++i) if ((t = lm[i]) && (r = (n = t.halfedges).length)) {
        ...
        if (n && e) {
            ...
            if (r !== o) {
                ...
                if (!(h >= -gm)) {
                    ...
                    for (var y = null, m = hm._; m;) if (g.y < m.y || g.y === m.y && g.x <= m.x) {
                        if (!m.L) {
                            y = m.P;
                            break
                        }
    ...
    function Gc(t) {
        for (var n, e, r, i, o = t[0], u = t[1], a = fm._; a;) if ((r = Jc(a, u) - o) > _m) a = a.L; else {
            if (!((i = o - Qc(a, u)) > _m)) {
    ...
    function ns(t, n) {
        ...
        for (pm = [], lm = new Array(t.length), fm = new kc, hm = new kc; ;) if (i = sm, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (Gc(o), e = o[0], r = o[1]), o = t.pop(); else {
            if (!i) break;
            Zc(i.arc)
        }
        if (Yc(), n) {
    ...
    var ls = function (t, n) {
    ...
    }, ps = hs(ls), ds = ps.right, vs = ps.left, _s = function (t) {
        return null === t ? NaN : +t
    }, gs = function (t, n) {
        var e, r, i = t.length, o = 0, u = -1, a = 0, c = 0;
        if (null == n) for (; ++u < i;) isNaN(e = _s(t[u])) || (c += (r = e - a) * (e - (a += r / ++o))); else for (; ++u < i;) isNaN(e = _s(n(t[u], u, t))) || (c += (r = e - a) * (e - (a += r / ++o)));
        if (o > 1) return c / (o - 1)
    }, ys = function (t, n) {
        var e = gs(t, n);
        ...
        return [r, i]
    }, xs = Array.prototype, bs = xs.slice, ws = xs.map, Ms = function (t) {
        return function () {
            return t
        }
    }, Ts = function (t) {
        ...
        return o
    }, ks = Math.sqrt(50), Ss = Math.sqrt(10), Es = Math.sqrt(2), As = function (t, n, e) {
        var i, o, u, a, c = -1;
        ...
        for (var n = -1, e = Rs(t, o), r = new Array(e); ++n < e;) for (var i, u = -1, a = r[n] = new Array(i); ++u < i;) a[u] = t[u][n];
        return r
    }, qs = Array.prototype.slice, Us = function (t) {
        return t
    }, Ds = 1, Os = 2, Fs = 3, Is = 4, Ys = 1e-6, Bs = {
        value: function () {
        }
    };
    ...
    var js = "http://www.w3.org/1999/xhtml", Hs = {
    ...
    pt.prototype = dt.prototype = {
        constructor: pt, select: function (t) {
            ...
            var e = "function" == typeof t ? t : $s(t), r = null == n ? ct : "function" == typeof n ? n : ef(n);
            return this.select(function () {
    ...
    var ff = function (t) {
        ...
        for (var r, i = 0, o = n ? n.length : 0; i < o; ++i) if ((r = n[i]).identifier === e) return tf(t, r);
        return null
    }, hf = function () {
        t.event.preventDefault(), t.event.stopImmediatePropagation()
    }, pf = function (t) {
        var n = t.document.documentElement, e = ff(t).on("dragstart.drag", hf, !0);
    ...
    var vf = function (t, n, e) {
        ...
        }, _f = "\\s*([+-]?\\d+)\\s*", gf = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)\\s*",
        yf = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*", mf = /^#([0-9a-f]{3})$/, xf = /^#([0-9a-f]{6})$/,
        bf = new RegExp("^rgb\\(" + [_f, _f, _f] + "\\)$"), wf = new RegExp("^rgb\\(" + [yf, yf, yf] + "\\)$"),
        Mf = new RegExp("^rgba\\(" + [_f, _f, _f, gf] + "\\)$"),
        Tf = new RegExp("^rgba\\(" + [yf, yf, yf, gf] + "\\)$"), Nf = new RegExp("^hsl\\(" + [gf, yf, yf] + "\\)$"),
        kf = new RegExp("^hsla\\(" + [gf, yf, yf, gf] + "\\)$"), Sf = {
            aliceblue: 15792383,
    ...
    var Ef = Math.PI / 180, Af = 180 / Math.PI, Cf = .95047, zf = 1, Pf = 1.08883, Rf = 4 / 29, Lf = 6 / 29,
        qf = 3 * Lf * Lf, Uf = Lf * Lf * Lf;
    vf(Dt, Ut, wt(Mt, {
        brighter: function (t) {
    ...
    var Df = -.14861, Of = 1.78277, Ff = -.29227, If = -.90649, Yf = 1.97294, Bf = Yf * If, jf = Yf * Of,
        Hf = Of * Ff - If * Df;
    vf(Vt, $t, wt(Mt, {
        brighter: function (t) {
            ...
            var t = isNaN(this.h) ? 0 : (this.h + 120) * Ef, n = +this.l, e = isNaN(this.s) ? 0 : this.s * n * (1 - n),
    ...
    var Xf, $f, Vf, Wf, Zf, Gf, Jf = function (t) {
            ...
            for (t += "", n += ""; (e = al.exec(t)) && (r = cl.exec(n));) (i = r.index) > o && (i = n.slice(o, i), a[u] ? a[u] += i : a[++u] = i), (e = e[0]) === (r = r[0]) ? a[u] ? a[u] += r : a[++u] = r : (a[++u] = null, c.push({
                i: u,
                x: ol(e, r)
            })), o = cl.lastIndex;
        ...
        }, hl = 180 / Math.PI, pl = {translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1},
        dl = function (t, n, e, r, i, o) {
            ...
            if (h < 1e-12) r = Math.log(s / u) / gl, e = function (t) {
                ...
                r = (g - _) / gl, e = function (t) {
                    var n = t * r, e = on(_), a = u / (2 * p) * (e * an(gl * n + _) - un(_));
                    return [i + a * f, o + a * l, u * e / on(gl * n + _)]
                }
            }
            return e.duration = 1e3 * r, e
        }, ml = cn(Jt), xl = cn(Kt), bl = sn(Jt), wl = sn(Kt), Ml = fn(Jt), Tl = fn(Kt), Nl = 0, kl = 0, Sl = 0, El = 1e3,
        Al = 0, Cl = 0, zl = 0, Pl = "object" == typeof performance && performance.now ? performance : Date,
    ...
    var Ll = function (t, n, e) {
        ...
        }, ql = h("start", "end", "interrupt"), Ul = [], Dl = 0, Ol = 1, Fl = 2, Il = 3, Yl = 4, Bl = 5, jl = 6,
        ...
        }, Vl = dt.prototype.constructor, Wl = 0, Zl = dt.prototype;
    Gn.prototype = Jn.prototype = {
        constructor: Gn,
        select: function (t) {
            var n = this._name, e = this._id;
            "function" != typeof t && (t = ef(t));
            for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u) for (var a, c, s = r[u], f = s.length, l = o[u] = new Array(f), h = 0; h < f; ++h) (a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ("__data__" in a && (c.__data__ = a.__data__), l[h] = c, Hl(l[h], n, e, h, l, wn(a, e)));
        ...
        transition: function () {
            for (var t = this._name, n = this._id, e = Qn(), r = this._groups, i = r.length, o = 0; o < i; ++o) for (var u, a = r[o], c = a.length, s = 0; s < c; ++s) if (u = a[s]) {
                var f = wn(u, n);
                Hl(u, t, e, s, a, {time: f.time + f.delay + f.duration, delay: 0, duration: f.duration, ease: f.ease})
            }
    ...
    var Gl = function t(n) {
            ...
            return n = +n, e.exponent = t, e
        }(3), Kl = Math.PI, th = Kl / 2, nh = 4 / 11, eh = 6 / 11, rh = 8 / 11, ih = .75, oh = 9 / 11, uh = 10 / 11,
        ah = .9375, ch = 21 / 22, sh = 63 / 64, fh = 1 / nh / nh, lh = function t(n) {
            function e(t) {
                return t * t * ((n + 1) * t - n)
            }

            return n = +n, e.overshoot = t, e
        }(1.70158), hh = function t(n) {
            function e(t) {
                return --t * t * ((n + 1) * t + n) + 1
            }

            return n = +n, e.overshoot = t, e
        }(1.70158), ph = function t(n) {
            function e(t) {
                return ((t *= 2) < 1 ? t * t * ((n + 1) * t - n) : (t -= 2) * t * ((n + 1) * t + n) + 2) / 2
            }

            return n = +n, e.overshoot = t, e
        }(1.70158), dh = 2 * Math.PI, vh = function t(n, e) {
            function r(t) {
        ...
        }(1, .3), yh = {time: null, delay: 0, duration: 250, ease: te};
    dt.prototype.interrupt = function (t) {
        ...
        for (var r = this._groups, i = r.length, o = 0; o < i; ++o) for (var u, a = r[o], c = a.length, s = 0; s < c; ++s) (u = a[s]) && Hl(u, t, n, s, a, e || oe(u, n));
        return new Gn(r, this._parents, t, n)
    };
    var mh = [null], xh = function (t) {
            return function () {
                return t
            }
        }, bh = function (t, n, e) {
            ...
            t.event.preventDefault(), t.event.stopImmediatePropagation()
        }, Mh = {name: "drag"}, Th = {name: "space"}, Nh = {name: "handle"}, kh = {name: "center"}, Sh = {
            ...
            se: "nwse-resize",
            sw: "nesw-resize"
        }, zh = {e: "w", w: "e", nw: "ne", ne: "nw", se: "sw", sw: "se"},
        Ph = {n: "s", s: "n", nw: "sw", ne: "se", se: "ne", sw: "nw"},
        Rh = {overlay: 1, selection: 1, n: null, e: 1, s: null, w: -1, nw: -1, ne: 1, se: 1, sw: -1},
        Lh = {overlay: 1, selection: 1, n: -1, e: null, s: 1, w: null, nw: -1, ne: -1, se: 1, sw: 1}, qh = Math.cos,
        Uh = Math.sin, Dh = Math.PI, Oh = Dh / 2, Fh = 2 * Dh, Ih = Math.max, Yh = Array.prototype.slice,
        Bh = function (t) {
            return function () {
                return t
            }
        }, jh = Math.PI, Hh = 2 * jh, Xh = Hh - 1e-6;
        ...
        constructor: de, moveTo: function (t, n) {
            ...
            if (null === this._x1) this._ += "M" + (this._x1 = t) + "," + (this._y1 = n); else if (l > 1e-6) if (Math.abs(f * a - c * s) > 1e-6 && i) {
                var h = e - o, p = r - u, d = a * a + c * c, v = h * h + p * p, _ = Math.sqrt(d), g = Math.sqrt(l),
                    y = i * Math.tan((jh - Math.acos((d + l - v) / (2 * _ * g))) / 2), m = y / g, x = y / _;
    ...
    Se.prototype = Ee.prototype = {
        constructor: Se, has: $h.has, add: function (t) {
            return t += "", this["$" + t] = t, this
        }, remove: $h.remove, clear: $h.clear, values: $h.keys, size: $h.size, empty: $h.empty, each: $h.each
    };
    var Vh = {}, Wh = {}, Zh = 34, Gh = 10, Jh = 13, Qh = function (t) {
            function n(t, n) {
                function e() {
                    if (s) return Wh;
                    if (f) return f = !1, Vh;
                    ...
                    for (; a < u;) {
                        if ((e = t.charCodeAt(n = a++)) === Gh) f = !0; else if (e === Jh) f = !0, t.charCodeAt(a) === Gh && ++a; else if (e !== o) continue;
                        return t.slice(r, n)
                    }
        ...
        }, Kh = Qh(","), tp = Kh.parse, np = Kh.parseRows, ep = Kh.format, rp = Kh.formatRows, ip = Qh("\t"), op = ip.parse,
        up = ip.parseRows, ap = ip.format, cp = ip.formatRows, sp = function (t) {
            return function () {
                return t
            }
        }, fp = function () {
    ...
    var pp, dp = 10, vp = Math.PI * (3 - Math.sqrt(5)), _p = function (t, n) {
        ...
        "": function (t, n) {
            ...
            var e = _p(t, n);
            if (!e) return t + "";
            var r = e[0], i = e[1], o = i - (pp = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1, u = r.length;
    ...
    var Mp, Tp = function (t) {
        ...
        function n(t) {
            ...
            var a = (t = He(t)).fill, c = t.align, s = t.sign, f = t.symbol, l = t.zero, h = t.width, p = t.comma,
                ...
                g = "$" === f ? r[1] : /[%p]/.test(v) ? u : "", y = bp[v], m = !v || /[defgprs%]/.test(v);
            return d = null == d ? v ? 6 : 12 : /[gprs]/.test(v) ? Math.max(1, Math.min(21, d)) : Math.max(0, Math.min(20, d)), n.toString = function () {
                return t + ""
            }, n
        }

        var e = t.grouping && t.thousands ? yp(t.grouping, t.thousands) : Tp, r = t.currency, i = t.decimal,
            o = t.numerals ? mp(t.numerals) : Tp, u = t.percent || "%";
        return {
            format: n, formatPrefix: function (t, e) {
                var r = n((t = He(t), t.type = "f", t)), i = 3 * Math.max(-8, Math.min(8, Math.floor(gp(e) / 3))),
                    o = Math.pow(10, -i), u = Np[8 + i / 3];
                return function (t) {
                    return r(o * t) + u
                }
            }
    ...
    var zp, Pp, Rp, Lp, qp, Up, Dp, Op, Fp, Ip, Yp, Bp, jp, Hp, Xp, $p, Vp, Wp, Zp, Gp, Jp, Qp, Kp, td, nd, ed, rd, id,
        od, ud, ad, cd = new Ve, sd = 1e-6, fd = Math.PI, ld = fd / 2, hd = fd / 4, pd = 2 * fd, dd = 180 / fd,
        vd = fd / 180, _d = Math.abs, gd = Math.atan, yd = Math.atan2, md = Math.cos, xd = Math.ceil, bd = Math.exp,
        wd = Math.log, Md = Math.pow, Td = Math.sin, Nd = Math.sign || function (t) {
            ...
            sphere: Qe, point: Mr, lineStart: Nr, lineEnd: Er, polygonStart: function () {
    ...
    var Fd, Id, Yd, Bd, jd, Hd, Xd, $d, Vd, Wd, Zd, Gd = function (t) {
        ...
        var e = n[0], r = n[1], i = [Td(e), -md(e), 0], o = 0, u = 0;
        tv.reset();
        for (var a = 0, c = t.length; a < c; ++a) if (f = (s = t[a]).length) for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + hd, d = Td(p), v = md(p), _ = 0; _ < f; ++_, h = y, d = x, v = b, l = g) {
            var g = s[_], y = g[0], m = g[1] / 2 + hd, x = Td(m), b = md(m), w = y - h, M = w >= 0 ? 1 : -1, T = M * w,
                N = T > fd, k = d * x;
        ...
        var i;
        if (null == t) i = e * ld, r.point(-fd, i), r.point(0, i), r.point(fd, i), r.point(fd, 0), r.point(fd, -i), r.point(0, -i), r.point(-fd, -i), r.point(-fd, 0), r.point(-fd, i); else if (_d(t[0] - n[0]) > sd) {
            var o = t[0] < n[0] ? fd : -fd;
        ...
        function e(t, n, e) {
            var r = [1, 0, 0], o = sr(ar(t), ar(n)), u = cr(o, o), a = o[0], c = u - a * a;
            if (!c) return !e && t;
            var s = i * u / c, f = -i * a / c, l = sr(r, o), h = lr(r, s);
            fr(h, lr(o, f));
            var p = l, d = cr(h, p), v = cr(p, p), _ = d * d - v * (cr(h, h) - 1);
            if (!(_ < 0)) {
                var g = kd(_), y = lr(p, (-d - g) / v);
                if (fr(y, h), y = ur(y), !e) return y;
                var m, x = t[0], b = n[0], w = t[1], M = n[1];
                b < x && (m = x, x = b, b = m);
                var T = b - x, N = _d(T - fd) < sd, k = N || T < sd;
        ...
        var i = md(t), o = 6 * vd, u = i > 0, a = _d(i) > sd;
        return ev(n, function (t) {
            ...
            return {
                lineStart: function () {
                    ...
                    if (!i && (s = c = v) && t.lineStart(), v !== c && (!(p = e(i, d)) || Qd(i, p) || Qd(d, p)) && (d[0] += sd, d[1] += sd, v = n(d[0], d[1])), v !== c) f = 0, v ? (t.lineStart(), p = e(d, i), t.point(p[0], p[1])) : (p = e(i, d), t.point(p[0], p[1]), t.lineEnd()), i = p; else if (a && i && u ^ v) {
                        var g;
    ...
    }, lv = [null, null], hv = {type: "LineString", coordinates: lv}, pv = function (t, n) {
        return lv[0] = t, lv[1] = n, fv(hv)
    }, dv = {
        Feature: function (t, n) {
            return Zr(t.geometry, n)
        }, FeatureCollection: function (t, n) {
            for (var e = t.features, r = -1, i = e.length; ++r < i;) if (Zr(e[r].geometry, n)) return !0;
            return !1
        }
    }, vv = {
        Sphere: function () {
            ...
            for (var e = t.coordinates, r = -1, i = e.length; ++r < i;) if (Gr(e[r], n)) return !0;
            return !1
        }, LineString: function (t, n) {
            return Jr(t.coordinates, n)
        }, MultiLineString: function (t, n) {
            for (var e = t.coordinates, r = -1, i = e.length; ++r < i;) if (Jr(e[r], n)) return !0;
            return !1
        }, Polygon: function (t, n) {
            return Qr(t.coordinates, n)
        }, MultiPolygon: function (t, n) {
            for (var e = t.coordinates, r = -1, i = e.length; ++r < i;) if (Qr(e[r], n)) return !0;
            return !1
        }, GeometryCollection: function (t, n) {
            for (var e = t.geometries, r = -1, i = e.length; ++r < i;) if (Zr(e[r], n)) return !0;
            return !1
        }
    }, _v = function (t) {
        return t
        ...
        point: ci, lineStart: si, lineEnd: hi, polygonStart: function () {
    ...
    xi.prototype = {
        _radius: 4.5, _circle: bi(4.5), pointRadius: function (t) {
    ...
    var Bv = 16, jv = md(30 * vd), Hv = function (t, n) {
    ...
    var Gv = Array.prototype.slice, Jv = function (t) {
    ...
    }, o_ = (1 + Math.sqrt(5)) / 2, u_ = function t(n) {
    ...
    }(o_), c_ = function (t, n, e) {
        return (n[0] - t[0]) * (e[1] - t[1]) - (n[1] - t[1]) * (e[0] - t[0])
    }, s_ = [].slice, f_ = {};
    Ho.prototype = Go.prototype = {
        constructor: Ho, defer: function (t) {
    ...
    var l_ = function () {
        ...
        }, N_ = T_("text/csv", tp), k_ = T_("text/tab-separated-values", op), S_ = Array.prototype, E_ = S_.map,
        A_ = S_.slice, C_ = {name: "implicit"}, z_ = function (t) {
            return function () {
                return t
            }
        }, P_ = function (t) {
            return +t
        }, R_ = [0, 1], L_ = function (n, e, r) {
        ...
        }, U_ = new Date, D_ = new Date, O_ = Nu(function () {
        }, function (t, n) {
            t.setTime(+t + n)
        }, function (t, n) {
            return n - t
    ...
    var F_ = O_.range, I_ = 6e4, Y_ = 6048e5, B_ = Nu(function (t) {
            ...
            return t.getDate() - 1
        }), Z_ = W_.range, G_ = ku(0), J_ = ku(1), Q_ = ku(2), K_ = ku(3), tg = ku(4), ng = ku(5), eg = ku(6),
        rg = G_.range, ig = J_.range, og = Q_.range, ug = K_.range, ag = tg.range, cg = ng.range, sg = eg.range,
        fg = Nu(function (t) {
    ...
    var pg = hg.range, dg = Nu(function (t) {
            t.setUTCSeconds(0, 0)
        }, function (t, n) {
            t.setTime(+t + n * I_)
        }, function (t, n) {
        ...
        }), mg = yg.range, xg = Su(0), bg = Su(1), wg = Su(2), Mg = Su(3), Tg = Su(4), Ng = Su(5), kg = Su(6),
        Sg = xg.range, Eg = bg.range, Ag = wg.range, Cg = Mg.range, zg = Tg.range, Pg = Ng.range, Rg = kg.range,
        Lg = Nu(function (t) {
    ...
    var Dg, Og = Ug.range, Fg = {"-": "", _: " ", 0: "0"}, Ig = /^\s*\d+/, Yg = /^%/,
        Bg = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g;
    Na({
        dateTime: "%x, %X",
        date: "%-m/%-d/%Y",
    ...
    var jg = Date.prototype.toISOString ? function (t) {
        ...
        } : t.utcFormat("%Y-%m-%dT%H:%M:%S.%LZ"), Hg = +new Date("2000-01-01T00:00:00.000Z") ? function (t) {
            var n = new Date(t);
            return isNaN(n) ? null : n
        } : t.utcParse("%Y-%m-%dT%H:%M:%S.%LZ"), Xg = 1e3, $g = 60 * Xg, Vg = 60 * $g, Wg = 24 * Vg, Zg = 7 * Wg,
        Gg = 30 * Wg, Jg = 365 * Wg, Qg = function (t) {
        ...
        ry = Tl($t(300, .5, 0), $t(-240, .5, 1)), iy = Tl($t(-100, .75, .35), $t(80, 1.5, .8)),
        oy = Tl($t(260, .75, .35), $t(80, 1.5, .8)), uy = $t(),
        ...
        }, hy = Math.abs, py = Math.atan2, dy = Math.cos, vy = Math.max, _y = Math.min, gy = Math.sin, yy = Math.sqrt,
        my = 1e-12, xy = Math.PI, by = xy / 2, wy = 2 * xy;
    Ia.prototype = {
        areaStart: function () {
            this._line = 0
        }, areaEnd: function () {
    ...
    var My = function (t) {
        ...
        var n = Ya, e = Ba, r = ly(!0), i = null, o = My, u = null;
        ...
        var e = Ya, r = null, i = ly(0), o = Ba, u = ly(!0), a = null, c = My, s = null;
    ...
    var Ay = function () {
        ...
        var t = Ny().curve(Ey), n = t.curve, e = t.lineX0, r = t.lineX1, i = t.lineY0, o = t.lineY1;
    ...
    }, qy = Math.sqrt(1 / 3), Uy = 2 * qy, Dy = {
        draw: function (t, n) {
            var e = Math.sqrt(n / Uy), r = e * qy;
            t.moveTo(0, -e), t.lineTo(r, 0), t.lineTo(0, e), t.lineTo(-r, 0), t.closePath()
        }
    }, Oy = Math.sin(xy / 10) / Math.sin(7 * xy / 10), Fy = Math.sin(wy / 10) * Oy, Iy = -Math.cos(wy / 10) * Oy, Yy = {
        draw: function (t, n) {
            var e = Math.sqrt(.8908130915292852 * n), r = Fy * e, i = Iy * e;
            t.moveTo(0, -e), t.lineTo(r, i);
            for (var o = 1; o < 5; ++o) {
                var u = wy * o / 5, a = Math.cos(u), c = Math.sin(u);
    ...
    }, Xy = -.5, $y = Math.sqrt(3) / 2, Vy = 1 / Math.sqrt(12), Wy = 3 * (Vy / 2 + 1), Zy = {
        draw: function (t, n) {
            var e = Math.sqrt(n / Wy), r = e / 2, i = e * Vy, o = r, u = e * Vy + e, a = -o, c = u;
    ...
    }, Gy = [Ry, Ly, Dy, By, Yy, Hy, Zy], Jy = function () {
    };
    Ka.prototype = {
        areaStart: function () {
            this._line = 0
    ...
    tc.prototype = {
        areaStart: Jy, areaEnd: Jy, lineStart: function () {
    ...
    _c.prototype = {
        ...
        areaStart: function () {
            ...
            if (e) if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]); else for (var r = xc(t), i = xc(n), o = 0, u = 1; u < e; ++o, ++u) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[u], n[u]);
    ...
    kc.prototype = {
        constructor: kc, insert: function (t, n) {
            var e, r, i;
            if (t) {
            ...
            if (e = o ? u ? Cc(u) : o : u, i ? i.L === t ? i.L = e : i.R = e : this._ = e, o && u ? (r = e.C, e.C = t.C, e.L = o, o.U = e, e !== u ? (i = e.U, e.U = t.U, t = e.R, i.L = t, e.R = u, u.U = e) : (e.U = i, i = e, t = e.R)) : (r = t.C, t = e), t && (t.U = i), !r) if (t && t.C) t.C = !1; else {
                do {
                    if (t === this._) break;
                    if (t === i.L) {
    ...
    ns.prototype = {
        constructor: ns, polygons: function () {
            ...
            return this.cells.forEach(function (e, r) {
                if (o = (i = e.halfedges).length) for (var i, o, u, a = e.site, c = -1, s = n[i[o - 1]], f = s.left === a ? s.right : s.left; ++c < o;) u = f, f = (s = n[i[c]]).left === a ? s.right : s.left, u && f && r < u.index && r < f.index && Kc(a, u, f) < 0 && t.push([a.data, u.data, f.data])
            }), t
        }, links: function () {
    ...
    rs.prototype = {
        constructor: rs, scale: function (t) {
    ...
    t.version = "4.11.0", t.bisect = ds, t.bisectRight = ds, t.bisectLeft = vs, t.ascending = ls, t.bisector = hs, t.cross = function (t, n, r) {
        ...
        if (null == n) for (; ++o < r;) isNaN(e = _s(t[o])) ? --i : u += e; else for (; ++o < r;) isNaN(e = _s(n(t[o], o, t))) ? --i : u += e;
        if (i) return u / i
    }, t.median = function (t, n) {
        var e, r = t.length, i = -1, o = [];
        if (null == n) for (; ++i < r;) isNaN(e = _s(t[i])) || o.push(e); else for (; ++i < r;) isNaN(e = _s(n(t[i], i, t))) || o.push(e);
        ...
        function t(t) {
            var o, u, a, c, s, f, l = t.length, h = [], p = Ns(l), d = [], v = [], _ = v.groups = new Array(l),
                g = new Array(l * l);
            for (o = 0, s = -1; ++s < l;) {
        ...
        function t() {
            var t, a = Yh.call(arguments), c = n.apply(this, a), s = e.apply(this, a),
                f = +r.apply(this, (a[0] = c, a)), l = i.apply(this, a) - Oh, h = o.apply(this, a) - Oh, p = f * qh(l),
                d = f * Uh(l), v = +r.apply(this, (a[0] = s, a)), _ = i.apply(this, a) - Oh, g = o.apply(this, a) - Oh;
        ...
        var n = _e, e = ge, r = ye, i = me, o = xe, u = null;
        ...
        function n(n) {
            for (var e = 0, r = t.length; e < p; ++e) for (var i, a, c, f, l, h, d, v = 0; v < r; ++v) a = (i = t[v]).source, f = (c = i.target).x + c.vx - a.x - a.vx || fp(), l = c.y + c.vy - a.y - a.vy || fp(), f *= h = ((h = Math.sqrt(f * f + l * l)) - u[v]) / h * n * o[v], l *= h, c.vx -= f * (d = s[v]), c.vy -= l * d, a.vx += f * (d = 1 - d), a.vy += l * d
        }
        ...
        return Hp = Xp = null, Up === 1 / 0 || Dp === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[Up, Dp], [Op, Fp]]
    },t.geoCentroid = function (t) {
        $p = Vp = Wp = Zp = Gp = Jp = Qp = Kp = td = nd = ed = 0, Cd(t, Ud);
        var n = td, e = nd, r = ed, i = n * n + e * e + r * r;
        return i < 1e-12 && (n = Jp, e = Qp, r = Kp, Vp < sd && (n = Wp, e = Zp, r = Gp), (i = n * n + e * e + r * r) < 1e-12) ? [NaN, NaN] : [yd(e, n) * dd, Ge(r / kd(i)) * dd]
    },t.geoCircle = function () {
        function t() {
            var t = r.apply(this, arguments), a = i.apply(this, arguments) * vd, c = o.apply(this, arguments) * vd;
        ...
        var e = t[0] * vd, r = t[1] * vd, i = n[0] * vd, o = n[1] * vd, u = md(r), a = Td(r), c = md(o), s = Td(o),
            f = u * md(e), l = u * Td(e), h = c * md(i), p = c * Td(i), d = 2 * Ge(kd(Je(o - r) + u * c * Je(i - e))),
            v = Td(d), _ = d ? function (t) {
                var n = Td(t *= d) / v, e = Td(d - t) / v, r = e * f + n * h, i = e * l + n * p, o = e * a + n * s;
        ...
        var e, r, i, o, u, a, c = Vv(), s = $v().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
            f = $v().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), l = {
                point: function (t, n) {
                    a = [t, n]
                }
            };
        return t.invert = function (t) {
            ...
            return i = c.translate(t).clipExtent([[r - .455 * e, a - .238 * e], [r + .455 * e, a + .238 * e]]).stream(l), o = s.translate([r - .307 * e, a + .201 * e]).clipExtent([[r - .425 * e + sd, a + .12 * e + sd], [r - .214 * e - sd, a + .234 * e - sd]]).stream(l), u = f.translate([r - .205 * e, a + .212 * e]).clipExtent([[r - .214 * e + sd, a + .166 * e + sd], [r - .115 * e - sd, a + .234 * e - sd]]).stream(l), n()
        ...
        var t = Oi(Wi), n = t.center, e = t.rotate;
        ...
        function t(t) {
            ...
            var a = to(t), c = no(t), s = a.x - n(a, c) / 2, f = c.x + n(c, a) / 2;
        ...
        var e = u_, r = !1, i = 1, o = 1, u = [0], a = ko, c = ko, s = ko, f = ko, l = ko;
        return t.round = function (n) {
            return arguments.length ? (r = !!n, t) : r
        }, t.size = function (n) {
        ...
        var o = jo(r), u = jo(i), a = u[0] === o[0], c = u[u.length - 1] === o[o.length - 1], s = [];
        ...
        function t() {
            var t, s, f = +n.apply(this, arguments), l = +e.apply(this, arguments), h = o.apply(this, arguments) - by,
                p = u.apply(this, arguments) - by, d = hy(p - h), v = p > h;
            if (c || (c = t = ve()), l < f && (s = l, l = f, f = s), l > my) if (d > wy - my) c.moveTo(l * dy(h), l * gy(h)), c.arc(0, 0, l, h, p, !v), f > my && (c.moveTo(f * dy(p), f * gy(p)), c.arc(0, 0, f, p, h, v)); else {
                var _, g, y = h, m = p, x = h, b = p, w = d, M = d, T = a.apply(this, arguments) / 2,
                    N = T > my && (i ? +i.apply(this, arguments) : yy(f * f + l * l)),
                    k = _y(hy(l - f) / 2, +r.apply(this, arguments)), S = k, E = k;
                if (N > my) {
                    var A = Pa(N / f * gy(T)), C = Pa(N / l * gy(T));
                    (w -= 2 * A) > my ? (A *= v ? 1 : -1, x += A, b -= A) : (w = 0, x = b = (h + p) / 2), (M -= 2 * C) > my ? (C *= v ? 1 : -1, y += C, m -= C) : (M = 0, y = m = (h + p) / 2)
                }
                var z = l * dy(y), P = l * gy(y), R = f * dy(b), L = f * gy(b);
                if (k > my) {
                    var q = l * dy(m), U = l * gy(m), D = f * dy(x), O = f * gy(x);
                    if (d < xy) {
                        var F = w > my ? Oa(z, P, D, O, q, U, R, L) : [R, L], I = z - F[0], Y = P - F[1], B = q - F[0],
                            j = U - F[1], H = 1 / gy(za((I * B + Y * j) / (yy(I * I + Y * Y) * yy(B * B + j * j))) / 2),
        ...
        var n = Ra, e = La, r = ly(0), i = null, o = qa, u = Ua, a = Da, c = null;
        ...
        var n = Sy, e = ky, r = null, i = ly(0), o = ly(wy), u = ly(0);
        return t.value = function (e) {
            return arguments.length ? (n = "function" == typeof e ? e : ly(+e), t) : n
        ...
        function i(t, n) {
            var e = t.invertX(n[0][0]) - T, r = t.invertX(n[1][0]) - N, i = t.invertY(n[0][1]) - S,
                o = t.invertY(n[1][1]) - E;
        ...
        function a(t, n) {
            for (var e, r = 0, i = z.length; r < i; ++r) if ((e = z[r]).that === t) return e;
            return new c(t, n)
        }
        ...
        function s() {
            if (y.apply(this, arguments)) {
                var t = a(this, arguments), n = this.__zoom,
                    o = Math.max(w, Math.min(M, n.k * Math.pow(2, x.apply(this, arguments)))), u = nf(this);
        ...
        function f() {
            if (!g && y.apply(this, arguments)) {
                var n = a(this, arguments), e = ff(t.event.view).on("mousemove.zoom", function () {
                    if (xm(), !n.moved) {
                ...
                }, !0), o = nf(this), u = t.event.clientX, c = t.event.clientY;
        ...
        function l() {
            if (y.apply(this, arguments)) {
                var o = this.__zoom, a = nf(this), c = o.invert(a),
        ...
        var _, g, y = us, m = as, x = ss, b = fs, w = 0, M = 1 / 0, T = -M, N = M, S = T, E = N, A = 250, C = yl,
            z = [], P = h("start", "zoom", "end"), R = 500, L = 150, q = 0;
    ...
    },t.zoomTransform = is,t.zoomIdentity = mm,Object.defineProperty(t, "__esModule", {value: !0})
});